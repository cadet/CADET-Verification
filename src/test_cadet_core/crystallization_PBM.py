...
def crystallization_tests(n_jobs, database_path, small_test,
    ...
    EOC_c1 = get_EOC(N_x_ref, N_x_test_c1, settings_crystallization.CSTR_PBM_growth, 1000e-6, output_path)
    ...
    EOC_c2 = get_EOC(N_x_ref, N_x_test_c2, settings_crystallization.CSTR_PBM_growthSizeDep, 1000e-6, output_path)
    ...
    EOC_c3 = get_EOC(N_x_ref, N_x_test_c3, settings_crystallization.CSTR_PBM_primaryNucleationAndGrowth, 1000e-6, output_path)
    ...
    EOC_c4 = get_EOC(N_x_ref, N_x_test_c4, settings_crystallization.CSTR_PBM_primarySecondaryNucleationAndGrowth, 1000e-6, output_path)
    print("CSTR_PBM_primaryNucleationAndGrowth EOC:\n", EOC_c4)
    data = {
    ...
    EOC_c5 = get_EOC(N_x_ref, N_x_test_c5, settings_crystallization.CSTR_PBM_primaryNucleationGrowthGrowthRateDispersion, 1000e-6, output_path)
