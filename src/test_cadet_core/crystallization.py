...
# user specific path, only needed for source builds
Cadet.cadet_path = r"C:\Users\jmbr\OneDrive\Desktop\CADET_compiled\crystallization_commit_618c928\aRELEASE\bin\cadet-cli.exe"

#TODO settings are defined in this script, not in database (yet?)
