...
if run_aggregation_test:
    crystallization_aggregation_EOC_test(
        cadet_path, small_test=small_test, output_path=output_path)
...
if run_fragmentation_test:
    crystallization_fragmentation_EOC_test(
        cadet_path, small_test=small_test, output_path=output_path)
...
if run_aggregation_fragmentation_test:
    crystallization_aggregation_fragmentation_EOC_test(
        cadet_path, small_test=small_test, output_path=output_path)
...
if run_DPFR_constFrag_test:
    crystallization_DPFR_constFragmentation_EOC_test(
        cadet_path=cadet_path, small_test=small_test, output_path=output_path
    )
