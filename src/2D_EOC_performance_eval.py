...
file_path = r"C:\Users\jmbr\Downloads\convergence_2DDPFR3Zone_1comp.json"
# file_path = str(Path.cwd()) + r"\output\test_cadet-core\2Dchromatography\convergence_2DDPFR3Zone_1comp - Kopie.json"
...
with open(file_path, 'r') as f:
    ...
    plt.savefig(r"C:\Users\jmbr\Downloads\convergence_2DDPFR3Zone_1comp.png")
    plt.show()
