...
def run_model(ncol=120, par_ncells=4, n_points=800, fname='Gu2015_fig14_5.h5', **kwargs):
...
if __name__ == '__main__':
    ...
    if spatial_method == 'DG':
        t_phys, outlet = run_model(ncol=64, par_ncells=2, dg_polydeg=4, bulk_discretization=spatial_method,
                                   n_points=400, fname=f'Gu2015_fig14_5_{spatial_method}.h5', **model_kwargs)
    elif spatial_method == 'FV':
        t_phys, outlet = run_model(ncol=256, par_ncells=8, dg_polydeg=None, bulk_discretization=spatial_method,
                                   n_points=400, fname=f'Gu2015_fig14_5_{spatial_method}.h5', **model_kwargs)
    ...
    ax.grid(alpha=0.3)
    fig.tight_layout()
    outpath = os.path.join(HERE, f'Gu2015_fig14_5_comparison_{spatial_method}.png')
