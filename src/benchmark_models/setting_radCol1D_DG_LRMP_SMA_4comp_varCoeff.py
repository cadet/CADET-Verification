# -*- coding: utf-8 -*-
"""
Study 2, Config 6: Radial LRMP (with pores), 4 components, SMA kinetic, variable coefficients.
...
def get_model():
    ...
    pt.film_diffusion_dep = 'RADIAL_RECIPROCAL_POWER_LAW'
    pt.film_diffusion_dep_base = 1.0
    pt.film_diffusion_dep_exponent = 1.0 / 3.0
    pt.film_diffusion_dep_rinner = r_in
    pt.film_diffusion_dep_length = r_out - r_in
    pt.nbound = [1] * ncomp
