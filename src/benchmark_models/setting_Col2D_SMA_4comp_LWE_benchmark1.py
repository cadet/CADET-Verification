...
def get_model(
    ...
    par_radius = 4.5e-05
    R = column.col_radius
    eps_inner = kwargs.get('eps_inner', 0.37)
    eps_wall = kwargs.get('eps_wall', 0.37)
    dp = 2 * par_radius
    ...
    model.input.solver.time_integrator.ABSTOL = kwargs.get('idas_reftol', 1e-8)
    model.input.solver.time_integrator.RELTOL = kwargs.get('idas_reftol', 1e-6)
