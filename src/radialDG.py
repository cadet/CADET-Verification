...
Studies:
  ...
  2. SMA 4-comp — DG vs FV convergence for rLRM, rGRM, rLRMP
...
def radialDG_tests(n_jobs, small_test, output_path, cadet_path,
                   studies=None,
                   study1_polydegs=None, study1_node_types=None,
                   study1_ref_only=False, study1_skip_ref=False,
                   study2_configs=None, study2_polydegs=None,
                   study2_skip_fv=False, study2_skip_dg_rerun=False,
                   study3_dispersions=None, study3_polydegs=None, study3_methods=None,
                   fv_start_ncol=None, fv_n_disc=None):
    ...
    if not small_test:
        ...
        _n_disc_1 = {p: 4 for p in range(1, 6)}
    ...
    if _run(1) and not study1_skip_ref:
        try:
            fv_ref_model = refine_FV_WENO3(
                base_model_transport, 0,
                setting_name=fv_name_1,
    ...
    # ===========================================================================
    #  Study 2: SMA 4-comp — DG vs FV convergence for rLRM, rGRM, rLRMP
    # ===========================================================================
