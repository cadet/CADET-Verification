...
def test_selected_model_groups(
    ...
    run_transport_tests, run_binding_tests, run_chromatography_tests, run_chromatography_sensitivity_tests, run_chromatography_system_tests,
    run_crystallization_tests, run_MCT_tests, run_2Dmodels_tests, run_validation_tests
):
    ...
    with project_repo.track_results(results_commit_message=commit_message, debug=rdm_debug_mode):
        ...
        if run_validation_tests:
            validation.validation_tests(
                output_path=str(output_path) + "/validation",
                cadet_path=cadet_path
            )
