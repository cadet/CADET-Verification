...
def get_model():
    ...
    config.model.connections.switch_000.connections = np.array([ 0.0000e+00, 1.0000e+00,-1.0000e+00,-1.0000e+00, 4.1667e-08, 1.0000e+00,
      2.0000e+00,-1.0000e+00,-1.0000e+00, 4.1667e-08])
    ...
    config.model.unit_001.particle_type_000.adsorption.kernel = np.bytes_(b'MLP')
    config.model.unit_001.particle_type_000.adsorption.ndim = np.int32(1)
    config.model.unit_001.particle_type_000.adsorption.cp_vals = np.array([0.        ,0.19219219,0.37837838,0.75075075,1.5015015 ,3.003003  ,
     6.        ])
    config.model.unit_001.particle_type_000.adsorption.cs_vals = np.array([  1.29198742, 76.84778516,110.14325476,141.59781958,165.80146634,
     181.33282173,190.23846417])
    config.model.unit_001.particle_type_000.adsorption.trained_params = np.array([1.86490637e+01,3.31357112e-04,7.89170771e+03,3.28049204e-15,
...
model.filename = "GPR_Shallow_MLP_7.h5"
model.save()
